.class public Lcom/sec/android/provider/logsprovider/HanziToPinyin;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/sec/android/provider/logsprovider/HanziToPinyin$Token;
    }
.end annotation
...
.field private static sInstance:Lcom/sec/android/provider/logsprovider/HanziToPinyin;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/sec/android/provider/logsprovider/HanziToPinyin;->UNIHANS:[C
    ...
    sput-object v0, Lcom/sec/android/provider/logsprovider/HanziToPinyin;->PINYINS:[[B
    ...
    sput-object v0, Lcom/sec/android/provider/logsprovider/HanziToPinyin;->PINYIN_LV:[C
    ...
    sput-object v0, Lcom/sec/android/provider/logsprovider/HanziToPinyin;->PINYIN_LVE:[C
    ...
    sput-object v0, Lcom/sec/android/provider/logsprovider/HanziToPinyin;->PINYIN_NV:[C
    ...
    sput-object v0, Lcom/sec/android/provider/logsprovider/HanziToPinyin;->PINYIN_NVE:[C
    ...
    sput-object v0, Lcom/sec/android/provider/logsprovider/HanziToPinyin;->COLLATOR:Ljava/text/Collator;
...
.method protected constructor <init>(Z)V
    ...
    iput-object v0, p0, Lcom/sec/android/provider/logsprovider/HanziToPinyin;->PINYIN_NV_STR:Ljava/lang/String;

    .line 278
    const-string v0, "NVE"

    iput-object v0, p0, Lcom/sec/android/provider/logsprovider/HanziToPinyin;->PINYIN_NVE_STR:Ljava/lang/String;

    .line 279
    const-string v0, "LV"

    iput-object v0, p0, Lcom/sec/android/provider/logsprovider/HanziToPinyin;->PINYIN_LV_STR:Ljava/lang/String;

    .line 280
    const-string v0, "LVE"

    iput-object v0, p0, Lcom/sec/android/provider/logsprovider/HanziToPinyin;->PINYIN_LVE_STR:Ljava/lang/String;

    .line 328
    iput-boolean p1, p0, Lcom/sec/android/provider/logsprovider/HanziToPinyin;->mHasChinaCollator:Z
...
.method private addToken(Ljava/lang/StringBuilder;Ljava/util/ArrayList;I)V
    ...
    .prologue
    .line 620
    .local p2, tokens:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/sec/android/provider/logsprovider/HanziToPinyin$Token;>;"
    ...
    new-instance v1, Lcom/sec/android/provider/logsprovider/HanziToPinyin$Token;

    invoke-direct {v1, p3, v0, v0}, Lcom/sec/android/provider/logsprovider/HanziToPinyin$Token;-><init>(ILjava/lang/String;Ljava/lang/String;)V
...
.method public static getInstance()Lcom/sec/android/provider/logsprovider/HanziToPinyin;
    .locals 5
    ...
    .line 332
    const-class v1, Lcom/sec/android/provider/logsprovider/HanziToPinyin;

    monitor-enter v1

    .line 333
    :try_start_0
    sget-object v2, Lcom/sec/android/provider/logsprovider/HanziToPinyin;->sInstance:Lcom/sec/android/provider/logsprovider/HanziToPinyin;

    if-eqz v2, :cond_0

    .line 334
    sget-object v0, Lcom/sec/android/provider/logsprovider/HanziToPinyin;->sInstance:Lcom/sec/android/provider/logsprovider/HanziToPinyin;
    ...
    .line 344
    new-instance v0, Lcom/sec/android/provider/logsprovider/HanziToPinyin;

    const/4 v2, 0x1

    invoke-direct {v0, v2}, Lcom/sec/android/provider/logsprovider/HanziToPinyin;-><init>(Z)V

    sput-object v0, Lcom/sec/android/provider/logsprovider/HanziToPinyin;->sInstance:Lcom/sec/android/provider/logsprovider/HanziToPinyin;
...
.method private getToken(C)Lcom/sec/android/provider/logsprovider/HanziToPinyin$Token;
    .locals 13
    .parameter "character"
    ...
    .line 379
    new-instance v7, Lcom/sec/android/provider/logsprovider/HanziToPinyin$Token;

    invoke-direct {v7}, Lcom/sec/android/provider/logsprovider/HanziToPinyin$Token;-><init>()V

    .line 380
    .local v7, token:Lcom/sec/android/provider/logsprovider/HanziToPinyin$Token;
    ...
    iput-object v4, v7, Lcom/sec/android/provider/logsprovider/HanziToPinyin$Token;->source:Ljava/lang/String;
    ...
    iput v9, v7, Lcom/sec/android/provider/logsprovider/HanziToPinyin$Token;->type:I

    .line 386
    iput-object v4, v7, Lcom/sec/android/provider/logsprovider/HanziToPinyin$Token;->target:Ljava/lang/String;
    ...
    .line 389
    iput v12, v7, Lcom/sec/android/provider/logsprovider/HanziToPinyin$Token;->type:I
    ...
    .line 393
    :cond_1
    sget-object v9, Lcom/sec/android/provider/logsprovider/HanziToPinyin;->COLLATOR:Ljava/text/Collator;
    ...
    .line 399
    iput v11, v7, Lcom/sec/android/provider/logsprovider/HanziToPinyin$Token;->type:I
    ...
    .line 417
    .local v0, begin:I
    sget-object v9, Lcom/sec/android/provider/logsprovider/HanziToPinyin;->UNIHANS:[C
    ...
    .local v3, j:I
    :goto_3
    sget-object v9, Lcom/sec/android/provider/logsprovider/HanziToPinyin;->PINYINS:[[B
    ...
    iput-object v9, v7, Lcom/sec/android/provider/logsprovider/HanziToPinyin$Token;->target:Ljava/lang/String;
...
.method private pinyinSuffixType(C)I
    ...
    sget-object v0, Lcom/sec/android/provider/logsprovider/HanziToPinyin;->PINYIN_LV:[C
    ...
    .line 644
    sget-object v0, Lcom/sec/android/provider/logsprovider/HanziToPinyin;->PINYIN_LVE:[C
    ...
    .line 655
    sget-object v0, Lcom/sec/android/provider/logsprovider/HanziToPinyin;->PINYIN_NV:[C
    ...
    .line 666
    sget-object v0, Lcom/sec/android/provider/logsprovider/HanziToPinyin;->PINYIN_NVE:[C
...
.method public get(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    .line 555
    .local v6, tokens:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/sec/android/provider/logsprovider/HanziToPinyin$Token;>;"
    iget-boolean v7, p0, Lcom/sec/android/provider/logsprovider/HanziToPinyin;->mHasChinaCollator:Z
    ...
    .line 570
    invoke-direct {p0, v3, v6, v5}, Lcom/sec/android/provider/logsprovider/HanziToPinyin;->addToken(Ljava/lang/StringBuilder;Ljava/util/ArrayList;I)V
    ...
    const-string v8, "CscFeature_Contact_EnablePuzzySearch"

    invoke-virtual {v7, v8}, Lcom/sec/android/app/CscFeature;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v7

    const-string v8, "CHINAGSM"
    ...
    .line 591
    :cond_8
    invoke-virtual {p0, v0}, Lcom/sec/android/provider/logsprovider/HanziToPinyin;->getTokenIncludingSpecialSuffix(C)Lcom/sec/android/provider/logsprovider/HanziToPinyin$Token;

    move-result-object v4

    .line 597
    .local v4, t:Lcom/sec/android/provider/logsprovider/HanziToPinyin$Token;
    :goto_3
    iget v7, v4, Lcom/sec/android/provider/logsprovider/HanziToPinyin$Token;->type:I
    ...
    .line 594
    .end local v4           #t:Lcom/sec/android/provider/logsprovider/HanziToPinyin$Token;
    :cond_a
    invoke-direct {p0, v0}, Lcom/sec/android/provider/logsprovider/HanziToPinyin;->getToken(C)Lcom/sec/android/provider/logsprovider/HanziToPinyin$Token;

    move-result-object v4

    .restart local v4       #t:Lcom/sec/android/provider/logsprovider/HanziToPinyin$Token;
    goto :goto_3
    ...
    .line 607
    :cond_c
    iget v5, v4, Lcom/sec/android/provider/logsprovider/HanziToPinyin$Token;->type:I
...
.method protected getTokenIncludingSpecialSuffix(C)Lcom/sec/android/provider/logsprovider/HanziToPinyin$Token;
    .locals 14
    .parameter "character"
    ...
    .line 449
    new-instance v8, Lcom/sec/android/provider/logsprovider/HanziToPinyin$Token;

    invoke-direct {v8}, Lcom/sec/android/provider/logsprovider/HanziToPinyin$Token;-><init>()V
    ...
    .line 451
    .local v4, letter:Ljava/lang/String;
    iput-object v4, v8, Lcom/sec/android/provider/logsprovider/HanziToPinyin$Token;->source:Ljava/lang/String;
    ...
    iput v10, v8, Lcom/sec/android/provider/logsprovider/HanziToPinyin$Token;->type:I

    .line 457
    iput-object v4, v8, Lcom/sec/android/provider/logsprovider/HanziToPinyin$Token;->target:Ljava/lang/String;
    ...
    .line 461
    iput v13, v8, Lcom/sec/android/provider/logsprovider/HanziToPinyin$Token;->type:I
    ...
    .line 466
    :cond_1
    sget-object v10, Lcom/sec/android/provider/logsprovider/HanziToPinyin;->COLLATOR:Ljava/text/Collator;
    ...
    .line 473
    iput v12, v8, Lcom/sec/android/provider/logsprovider/HanziToPinyin$Token;->type:I
    ...
    .line 493
    .local v0, begin:I
    sget-object v10, Lcom/sec/android/provider/logsprovider/HanziToPinyin;->UNIHANS:[C
    ...
    .line 495
    .local v2, end:I
    invoke-direct {p0, p1}, Lcom/sec/android/provider/logsprovider/HanziToPinyin;->pinyinSuffixType(C)I
    ...
    .local v3, j:I
    :goto_3
    sget-object v10, Lcom/sec/android/provider/logsprovider/HanziToPinyin;->PINYINS:[[B
    ...
    iput-object v10, v8, Lcom/sec/android/provider/logsprovider/HanziToPinyin$Token;->target:Ljava/lang/String;
